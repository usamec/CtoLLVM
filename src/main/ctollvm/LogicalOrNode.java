...
public class LogicalOrNode implements PNode {
  private PNode lhs;
  private PNode rhs;

  public LogicalOrNode(PNode lhs, PNode rhs) {
    this.lhs = lhs;
    this.rhs = rhs;
  }
  ...
  public EvalResult produceOutput(PrintStream out) throws Exception { 
    ...
    out.printf("br label %%%s\n", labell2);
    out.printf("%s:\n", labell2);
    // Ak je l false, tak pokracuje vo vyhodnocovani, ak je true, tak skaceme rovno za to
    out.printf("br i1 %s, label %%%s, label %%%s\n",
        l.getRepresentation(), labelafter, labelr);
